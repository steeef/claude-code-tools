...
## 16:05 - Two-Part Find Options Menu

**Session ID:** 28995005-b45f-4fcf-86d3-784ca13590b8

**Files Modified:**
- `node_ui/menu.js` - Rewrote `FindOptionsForm` with two-part menu:
  - Top: Action menu ("Submit search", "Edit options...")
  - Bottom: Full form (always visible, read-only in action mode)
  - Mode switching between 'action' and 'edit'
  - Esc from edit mode returns to action menu

**Description:**
- Solves submit key problem (Ctrl+Enter/Shift+Enter captured by macOS/terminals)
- User presses Enter on "Submit search" to submit
- "Edit options..." enters form edit mode with ↑/↓ navigation, toggles, text input
- Esc from edit mode returns to action menu for easy submit
